...
|----------|-----------|---------|--------|
| TypeScript | [`typescript/`](typescript/) | `@corpus-relica/reflex` | v0.3.0 — 284 tests, ESM + CJS |
| Go | [`go/`](go/) | `github.com/corpus-relica/reflex/go` | v0.3.0 — 125 tests, stdlib only, zero dependencies |
